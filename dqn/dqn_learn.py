...
def dqn_learing(env, q_func, optimizer_spec, exploration, stopping_criterion=None, replay_buffer_size=1000000, batch_size=32, gamma=0.99, learning_starts=50000, learning_freq=4, frame_history_len=4, target_update_freq=10000):
    ...
    for t in count():
        ...
        if t > learning_starts:
            action = select_epilson_greedy_action(Q, replay_buffer.encode_recent_observation(), t)[0].item()
        else:
